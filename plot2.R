# file name:   plot2.R
# description: This the program is the second plot of the Course Project 1 of EDA.
...
#              line chart of the "Global Active Power" between 2007-02-01 and
#              2007-02-02 according to the eamples. The figure will be saved in
#              PNG format with file name "plot2.PNG". Finally, the device will
